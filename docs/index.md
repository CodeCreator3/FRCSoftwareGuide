...
## Prerequisites
- Familiarity with FIRST Robotics and FIRST Robotics Competition (how the program works)
- A functional laptop/PC
- Some time
- A drive to learn
- Optional: A robot with a mechanism to test with
